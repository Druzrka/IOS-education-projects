...
//  ProgressBar
//
//  Created by Zakhar Azatyan on 25.09.17.
...
public class ProgressBarDraw : NSObject {
    ...
    @objc dynamic public class func drawProgressBar(frame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 16), progress: CGFloat = 185) {
        //// General Declarations
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }

        //// Color Declarations
        let color2 = UIColor(red: 0.264, green: 0.688, blue: 0.257, alpha: 1.000)
